...
echo_and_run cd "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/xhnfly/Cosmic_rays_X/X_ROS/build/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
