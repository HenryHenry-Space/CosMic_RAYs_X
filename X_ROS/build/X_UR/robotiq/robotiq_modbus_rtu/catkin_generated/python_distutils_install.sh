...
echo_and_run cd "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/xhnfly/Cosmic_rays_X/X_ROS/build/X_UR/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
