...
echo_and_run cd "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/xhnfly/Cosmic_rays_X/X_ROS/build/X_UR/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
