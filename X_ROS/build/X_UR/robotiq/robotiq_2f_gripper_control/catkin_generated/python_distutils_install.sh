...
echo_and_run cd "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/xhnfly/Cosmic_rays_X/X_ROS/build/X_UR/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
