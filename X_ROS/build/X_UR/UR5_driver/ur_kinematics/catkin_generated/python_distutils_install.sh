...
echo_and_run cd "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/UR5_driver/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xhnfly/Cosmic_rays_X/X_ROS/src/X_UR/UR5_driver/ur_kinematics/setup.py" \
     \
    build --build-base "/home/xhnfly/Cosmic_rays_X/X_ROS/build/X_UR/UR5_driver/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
