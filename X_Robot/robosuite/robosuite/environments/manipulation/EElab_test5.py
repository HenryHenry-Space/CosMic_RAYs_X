...
class EElab_test5(SingleArmEnv):
    ...
    def staged_rewards(self):
        ...
        mount_touch_sensor = self.sim.data.get_sensor('touchsensor_mount')
        if touch_sensor != 0:
            r_reach -=(0.01*touch_sensor+0.01*mount_touch_sensor)
            # r_reach -=0.1
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            @sensor(modality=modality)
            def mount_contect(obs_cache):
                return np.array(self.sim.data.get_sensor('touchsensor_mount'))
